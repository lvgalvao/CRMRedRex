...
function createDealFromBooking(
  b: Booking,
  ownerId: string,
...
type Close =
  ...
  | {
      status: "lost";
      lostReason: "preço" | "timing" | "concorrente" | "sem_budget" | "sumiu" | "outro";
    }
...
```ts
function createProposalVersion(
  dealId: string,
  input: { value: number; validUntil?: string; docUrl?: string },
