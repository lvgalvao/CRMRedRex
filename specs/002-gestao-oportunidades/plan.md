...
| ------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| **I. Orientação a vendas**                        | Responde às três perguntas: cadastro manual traz para o CRM a venda que nasce fora do agendamento (_o que eu faço hoje?_); previsão de fechamento e probabilidade ajustável tornam o forecast fiel (_quanto vamos fechar este mês?_); o histórico com tempo de permanência mostra onde a venda trava (_o que funciona pra vender?_). Nada fora dessas três. | ✅ PASS              |
...
**Ressalva registrada** (ver Complexity Tracking): o trigger coloca a _escrita_ do histórico no banco, e não em `lib/services/`. É uma concessão deliberada — a alternativa em serviço não garante FR-020 nem SC-002. A _decisão_ (qual etapa, se reabre, o que valida) permanece integralmente nos serviços; o trigger só materializa o registro.
